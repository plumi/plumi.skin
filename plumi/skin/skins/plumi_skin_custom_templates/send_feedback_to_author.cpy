## Controller Python Script "send_feedback_to_author"
...
message_status = 'Mail Sent'
newclass = 'info'
infohead = 'Info'
message = ''
status_output = state_success
...
status_output = state_success ## until proven otherwise
...
if status_output == state_success:
...
#return message_status,newclass,infohead
